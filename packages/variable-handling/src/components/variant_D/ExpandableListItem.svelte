<script>
  ...
  const MAPPING_TYPES = [
    ...
    {
      id: 'inline-js-script',
      name: 'Inline Javascript Script'
    },
    {
      id: 'inline-jruby-script',
      name: 'Inline JRuby Script'
    },
    {
      id: 'inline-groovy-script',
      name: 'Inline Groovy Script'
    },
    {
      id: 'external-script',
...
<div class="variable" id={`variable-${variable.id}`}>
  ...
  <div class="variable-details">
    ...
    {#if selectedMappingType === 'inline-js-script' || selectedMappingType === 'inline-jruby-script' || selectedMappingType === 'inline-groovy-script' }
      <label>Script</label>
      <textarea
        name="script-content"
        rows="5"></textarea>
